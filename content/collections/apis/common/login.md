...
title: ニコニコログイン
slug: common/login
description: ニコニコログインがゲームアツマールのAPIに及ぼす影響について
order: 1
navi: 共通事項
---
  
## ニコニコログインについて
ゲームアツマールでは、ユーザーはニコニコログインをすることで **ログイン状態** になることができます。
    
この状態でコメントをしたり、ゲームを投稿したりすることができますが、アツマールAPIでもログイン状態を使った機能がいくつか提供されています。
